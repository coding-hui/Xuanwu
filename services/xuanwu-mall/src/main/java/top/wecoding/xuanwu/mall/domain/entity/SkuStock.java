...
public class SkuStock extends LogicDeleteEntity implements Serializable {
  ...
  /**
   * 详细的份量数字 1.填数量(对应weight_unit中 1，2) 2.无需再填数量(对应weight_unit中3) 用法： ① 0表示清空 weight,weight_unit ②
   * -1和null 表示不更新weight,weight_unit；-2表示weight_unit需设置【xx人份】，例如：weight=-2，weight_unit="6人份" ③
   * 其他正常设置weight,weight_unit
   */
  private Long weight;

  /**
   * 重量单位或份量单位 1）取值为：克、千克、两、斤、磅、盎司、毫升、升、寸、厘米 2）取值为：个、串、枚、粒、 块、只、副、卷、片、贯、碗、杯、袋、瓶、盒、包、锅、罐、扎
