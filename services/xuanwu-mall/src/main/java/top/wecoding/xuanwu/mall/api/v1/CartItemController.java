...
public class CartItemController {
    ...
    @PutMapping("/{id}")
    public R<CartItem> update(@PathVariable("id") Long id, @RequestBody @Validated CartItem cartItem) {
    ...
    public R<?> deleteCartItem(@RequestParam("foodId") Long foodId, @RequestParam("tableCode") String tableCode) {
