...
public class BaseExceptionHandler {
  ...
  @ResponseStatus(HttpStatus.NOT_FOUND)
  public R<Object> invalidApiVersionException(
      InvalidApiVersionException e, HttpServletRequest request) {
  ...
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  public R<Object> missParamException(
  ...
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  public R<Object> validatedBindException(
  ...
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  public R<Object> constraintViolationException(
  ...
  private String exceptionMessage(String message, HttpServletRequest request) {
    return String.format(
        message + ": URI [%s] method [%s]", request.getRequestURI(), request.getMethod());
  }
}
