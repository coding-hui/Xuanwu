...
public class JsonUtil {
   ...
   */
  @Nullable
  public static String toJsonStr(@Nullable Object object) {
    if (object == null) {
      return null;
    }
    try {
  ...
  /**
   * 将对象序列化成 json 字符串，美化格式
   *
   * @param object bean
   * @return jsonString json str
   */
  @Nullable
  public static String toPrettyJsonStr(@Nullable Object object) {
    if (object == null) {
      return null;
    }
    try {
   ...
   * 封装参数化类型
   *
   * <p>例如： Map.class, String.class, String.class 对应 Map[String, String]
   *
   ...
   */
  public static <K, V> Map<K, V> readMap(
      @Nullable Reader reader, Class<?> keyClass, Class<?> valueClass) {
    if (reader == null) {
      return Collections.emptyMap();
    }
    try {
   ...
   * @return 是否成功
   */
  public static boolean isValidJson(FailableConsumer<ObjectMapper, Throwable> consumer) {
  ...
  private static class JacksonObjectMapper extends ObjectMapper {
    ...
    @Serial private static final long serialVersionUID = 4288193147502386170L;
    ...
    private static JsonFactory jsonFactory() {
      return JsonFactory.builder()
          ...
          // 允许json str包含非引号控制字符（值小于32的ASCII字符，包含制表符和换行符）
