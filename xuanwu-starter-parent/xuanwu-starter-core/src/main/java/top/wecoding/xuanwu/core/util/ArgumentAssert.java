...
public class ArgumentAssert {
	...
	public static void doesNotContain(@Nullable String textToSearch, String substring, ErrorCode supplier,
			Object... args) {
	...
	public static void noNullElements(@Nullable Collection<?> collection, ErrorCode supplier, Object... args) {
