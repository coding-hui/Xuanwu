...
public class Classes {
	...
	public static Class findClassByName(String className) {
		try {
			...
			throw new IllegalArgumentException(String.format("Unable to load class named [%s]", className));
		}
	}
	...
	public static <T> T newInstance(Class<T> clazz) {
		...
		try {
			...
			throw new InstantiationException(String.format("Unable to instantiate class [%s]", clazz.getName()), e);
		}
	}
