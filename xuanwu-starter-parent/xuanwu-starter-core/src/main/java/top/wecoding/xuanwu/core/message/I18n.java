...
public class I18n {
	...
	public static String getMessage(String code, String defaultMessage, Locale locale) {
		return DEFAULT_MESSAGE_SOURCE.resolveMessage(PARENT_MESSAGE_SOURCE, code, null, defaultMessage, locale);
	}
	...
	public static String getMessage(String code, Object[] args, String defaultMessage, Locale locale) {
		return DEFAULT_MESSAGE_SOURCE.resolveMessage(PARENT_MESSAGE_SOURCE, code, args, defaultMessage, locale);
	}
