package top.wecoding.xuanwu.ai.minimax.chat;
...
import top.wecoding.xuanwu.ai.minimax.MiniMaxAiTestConfiguration;
import top.wecoding.xuanwu.ai.minimax.testutils.AbstractTest;
 ...
 */
@Slf4j
@SpringBootTest(classes = MiniMaxAiTestConfiguration.class)
@EnabledIfEnvironmentVariable(named = "MINIMAX", matches = ".+")
public class MiniMaxAiChatClientTest extends AbstractTest {
